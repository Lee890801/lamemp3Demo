...
public final class FileUtils {
    ...
    public static String getRootPath(Context context, String name, boolean hasNoMedia) {
        String path = null;
    ...
    private static String createRootDirInDevMount() {
        ...
        if (dirs != null) {
            for (int i = 0; i < dirs.size(); i++) {
                ...
                Log.d("TEST", Arrays.toString(new File(tmpPath).list()));
            }
        }
